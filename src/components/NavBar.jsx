    ...
    <header className="sticky top-0 z-10 border-b border-[var(--color-border)] bg-[var(--color-pitch)]/90 backdrop-blur-md">
      <div className="mx-auto flex max-w-3xl items-center justify-between px-4 py-3">
        ...
        <div className="flex items-center gap-2">
          <a
            href="https://discord.gg/UY5ydwZM7E"
            target="_blank"
            rel="noopener noreferrer"
            title="Rejoindre le Discord"
            className="flex items-center gap-1.5 rounded-lg px-2.5 py-1.5 text-sm font-medium text-[var(--color-text-dim)] transition-colors hover:bg-[var(--color-panel-2)] hover:text-white"
          >
